...
<head>
    ...
    <title>Inicio: Personal RR.HH</title>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a id="check" class="nav-link active" aria-current="page" href="modificar_mi_formulario.php?rut=<?php echo $rut ?>&correo=<?php echo $correo_recibido ?>">Modificar mi formulario</a></li>
              ...
              <li class="nav-item dropdown">
                <a id="check" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Funciones Personal RR.HH
                </a>
                <ul class="dropdown-menu">

                  <li class="dropdown-item"><a class="nav-link active" aria-current="page" href="crear_perfil.php?correo=<?php echo $correo_recibido ?>">Crear Perfil</a></li>
