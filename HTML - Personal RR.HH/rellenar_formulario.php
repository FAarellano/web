...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a id="volver" class="btn btn-outline-warning" aria-current="page" href="menu_personal.php?correo=<?php echo $correo_recibido ?>">Regresar</a>
                    </li>
    ...
    <form action="../php/rellenar_formulario_perso.php?correo=<?php echo $correo_recibido ?>" method="POST">
        <!--INICIO BODY-->
